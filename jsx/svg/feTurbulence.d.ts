...
interface FeTurbulanceSVGAttributes<T> extends FilterPrimitiveElementSVGAttributes<T>, StylableSVGAttributes {
	baseFrequency?: number | string | false
	numOctaves?: number | string | false
	seed?: number | string | false
	stitchTiles?: 'stitch' | 'noStitch' | false
	type?: 'fractalNoise' | 'turbulence' | false
}
...
interface SVGFETurbulenceElementAttributes<Element> extends SVGAttributes<Element> {}
